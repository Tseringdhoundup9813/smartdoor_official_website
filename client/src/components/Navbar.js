...
// totalcartlist how=============================
  async function totalcartlistcount(){
    try{
        let carttotal=  await  axios.get(`https://node.smartdoors.com.np/totalcartlistcount/${localStorage.getItem("user_id")}`)
...
// end ===================
    ...
    async function VerifyEmailSend(){
        ...
        const verifySend = await axios.get(`verifyEmail/${(localStorage.getItem("user_id"))}`)
            ...
            <nav className="navbar navbar-expand-md bg-body-tertiary ">
                <div className="container-fluid navbar-container">
                    ...
                    <ul className="navbar-nav navbar-ul">
                        ...
                        <li className="nav-item">
                        <NavLink to="/products" className="nav-link text-capitalize" onClick={navItem}>product</NavLink>
                        </li>
