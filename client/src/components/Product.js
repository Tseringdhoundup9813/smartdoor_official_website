...
function Product() {
  ...
  async function getProduct() {
    try {
      let res = await axios.get(
        `https://node.smartdoors.com.np/product?page=${pageCount}&limit=20&colors=${filterColor}&category=${filtercategory}&size=${filterSize}`
      );
  ...
  function deleteConfirmYes() {
    axios
      .delete(`https://localhost:3001/delete?id=${deleteID}`)
      .then((res) => {
