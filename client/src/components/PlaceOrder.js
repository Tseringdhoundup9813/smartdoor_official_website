...
export default function PlaceOrder() {
    ...
    if(params.get("pidx") !==null){
        ...
        async function CheckPidx(){
            ...
            try{
                const response= await  axios.get(`https://node.smartdoors.com.np/checkpidx/${pidx}/${localStorage.getItem("order_id")}`)
    ...
    async function totalproductamount(){
        ...
        try{
            const totalamount = await  axios.get(`https://node.smartdoors.com.np/totalamount/${localStorage.getItem("user_id")}`)
    ...
    async function confirmOrder(){
        try{
            const order = await axios.post(`https://node.smartdoors.com.np/orderconfirm`,{order_id:order_id})
    ...
    // pay on khalti =====================================================================================================
     async function KhaltiPay(){
        try{
            const order = await axios.get(`https://node.smartdoors.com.np/khaltipayload/${localStorage.getItem("order_id")}`)
